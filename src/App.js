...
class App extends React.Component {
    ...
    render () {
        return (
            <div className='App'>
                <div>
                    <input type='text' name='title' placeholder='请输入标题' onChange={this.handlerForm}/>
                    <br/>
                    <textarea name='content' cols='30' rows='10' placeholder='请输入内容' onChange={this.handlerForm}></textarea>
                    <br/>
